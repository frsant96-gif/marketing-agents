# Checklist SAP NOW AI Tour 2026

**Evento:** 9 e 10 de setembro de 2026 | Transamérica Expo Center — São Paulo
**Responsável geral:** Francielle Beline
...
| Item | Fornecedor | Valor R$ | N° NF | CC | OBS |
|------|-----------|----------|-------|----|-----|
...
| Gráfica (display QR Code) | Kalunga | A preencher | | | Impressão de arte para display |
| Arte do estande (agência) | A contratar | A orçar | | | Trainel + painel + balcão |
| Ativação (totem holográfico) | A contratar | A orçar | | | Cubo montando/desmontando |
| LinkedIn Ads + Google Ads | A contratar | A orçar | | | Geolocalização 07-11/set |
| Hotel da equipe | A contratar | A orçar | | | |
| **TOTAL parcial** | | **R$ 276.869,83** | | | Itens em aberto não incluídos |

---

## Fase 1 — Junho (URGENTE)

| Atividade | Prazo | Status | Responsável | OBS |
|-----------|-------|--------|-------------|-----|
...
| Lançar campanha pré-evento LinkedIn + email | Jun | Pendente | Fran | "Diagnóstico BDC Reservado" |
...
| Produção da apresentação da sessão de conteúdo (20 min) | Ago | Pendente | Fran + Klabin | Slides aprovados pela SAP antes do evento |
| Aprovação da apresentação pela SAP | Ago | Pendente | Fran | Obrigatório — planejar tempo para revisão |
| Produção do vídeo looping (futurístico) | Ago | Pendente | Fran + Fornecedor | Roteiro: Prêmio BDC → Cases → Dashboards → IA → CTA. R$ 5.280,00 |
...
| Finalizar campanha pré-evento LinkedIn + email | Ago | Pendente | Fran | Última onda antes do evento |
| Continuar abordagem SDR empresas-alvo | Ago | Pendente | SDR | Foco em confirmação de presença e agenda no estande |

---

## Fase 4 — Pré-evento (Setembro)
...
## Fase 5 — Evento (09 e 10/09)

| Atividade | Prazo | Status | Responsável | OBS |
|-----------|-------|--------|-------------|-----|
| Operação do estande — Dia 1 manhã | 09/09 8h-13h30 | — | Alexandre, Andrey, Molina, Fracchetta, Renan, Ferreira, Lucas, Bianca, Fran | |
| Operação do estande — Dia 1 tarde | 09/09 13h30-19h | — | Eduardo Savoine (troca) | Horário de troca: 12h-14h |
...
| Reposição de brindes e materiais | 10/09 20h-22h | — | Equipe | Janela de reposição CAEX |
...
| Enviar email de agradecimento personalizado | D+1 (10/09) | — | Fran | Segmentar por dor declarada |
| Email com valor (case Klabin) para leads mornos | D+3 (12/09) | — | Fran | |
