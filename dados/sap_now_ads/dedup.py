...
OUT_XLSX = "Empresas_SAP_NOW_deduplicadas.xlsx"
...
def main():
    ...
    with pd.ExcelWriter(OUT_XLSX, engine="openpyxl") as writer:
        df.to_excel(writer, sheet_name="Empresas unicas", index=False)
        # aba só com a lista limpa, uma coluna
        df[["Empresa (nome final)"]].to_excel(writer, sheet_name="Lista simples", index=False)
